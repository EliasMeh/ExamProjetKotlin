...
import com.example.examprojet.model.MasseMonetaireRepository
import com.example.examprojet.model.TauxInteretRepository
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import kotlinx.coroutines.withContext

class MasseMonetaireViewModel : ViewModel() {
    private val MasseMonetaireRepo = MasseMonetaireRepository()
        ...
        viewModelScope.launch {
            try {
                withContext(Dispatchers.IO) {
                    val exchangeRates = MasseMonetaireRepo.getMasseMonetaireRate()
